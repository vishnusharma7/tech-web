...
const Services = () => {
  ...
  let activeTab = tabData[0].title; // Initialize active tab

  const handleTabClick = (title) => {
    const tabs = document.querySelectorAll(".tab"); // Select all tabs
    const contents = document.querySelectorAll(".content"); // Select all contents

    tabs.forEach((tab) => {
      if (tab.dataset.title === title) {
        activeTab = title;
        tab.classList.add(
          "active",
          "shadow-[6px_6px_30px_rgba(0,_0,_0,_0.05)]",
          "border-[1px]",
          "border-solid",
  ...
  return (
    <section className="self-stretch bg-secondary-light-10 overflow-hidden flex flex-row items-center justify-center py-[100px] px-5 box-border max-w-full text-left text-xl text-secondary-dark-20 font-sub-headings-sub-heading-26px-semibold mq750:pt-[42px] mq750:pb-[42px] mq750:box-border mq1050:pt-[65px] mq1050:pb-[65px] mq1050:box-border">
      <div className="w-[1240px] flex flex-col items-center justify-start gap-[50px] max-w-full mq750:gap-[50px]">
        ...
        <div className="self-stretch flex flex-col items-start justify-start gap-[30px] max-w-full">
          <div className="self-stretch flex flex-row flex-wrap items-start justify-center gap-[10px]">
            ...
            <button className="cursor-pointer py-5 pr-[21px] pl-[19px] bg-secondary-light-10 rounded-xl shadow-[6px_6px_30px_rgba(0,_0,_0,_0.05)] box-border flex flex-row items-start justify-start gap-[14px] min-w-[150px]  border-[1px] border-solid border-secondary-light-70">
            ...
            <button className="cursor-pointer py-5 pr-[21px] pl-[19px] bg-secondary-light-10 rounded-xl shadow-[6px_6px_30px_rgba(0,_0,_0,_0.05)] box-border flex flex-row items-start justify-start gap-[14px] min-w-[150px] ">
              <div className="rounded-md bg-primary-80 overflow-hidden flex flex-row items-center justify-center py-1 px-[5px]">
                <img
                  className="h-[22px] w-[22px] relative overflow-hidden shrink-0"
                  alt=""
