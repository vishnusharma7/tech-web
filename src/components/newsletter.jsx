const Newsletter = () => {
  return (
    <section className="self-stretch bg-primary-dark-80 box-border overflow-hidden flex flex-row items-center justify-center py-20 px-[260px] relative gap-[10px] max-w-full text-center text-23xl text-secondary-light-10 font-paragraphs-para-18px-semibold border-t-[4px] border-solid border-mediumblue mq450:py-[52px] mq450:px-5 mq450:box-border mq750:pl-[65px] mq750:pr-[65px] mq750:box-border mq1250:pl-[130px] mq1250:pr-[130px] mq1250:box-border">
      <div className="w-[650px] flex flex-col items-center justify-center gap-[20px] min-w-[360px] max-w-full">
        ...
        <div className="self-stretch flex flex-row flex-wrap items-start justify-center gap-[10px] max-w-full z-30">
          <input
            ...
            type="text"
          />
          <button className="cursor-pointer [border:none] py-[15px] px-[25px] bg-[transparent] rounded-26xl-7 [background:linear-gradient(140.99deg,_#aace88,_#211e3b_76.04%,_#211e3b_84.38%,_#211e3b)] shadow-[4px_4px_30px_rgba(0,_0,_0,_0.04)] flex flex-row items-center justify-center box-border gap-[9.14px] min-w-[140px] whitespace-nowrap">
