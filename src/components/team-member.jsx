...
const TeamMember = ({ image }) => {
  ...
  return (
    <div className="w-[393px] rounded-xl bg-secondary-light-10 shadow-[5px_5px_30px_rgba(0,_0,_0,_0.05)] box-border overflow-hidden flex flex-col items-center justify-center min-w-[157px] max-w-full text-left text-sm text-secondary-dark-40 font-paragraphs-para-18px-semibold border-[1px] border-solid border-secondary-light-80">
      <img
      ...
      <div className="self-stretch flex flex-col items-start justify-center py-5 px-[30px] box-border gap-[16px] min-w-[280px]">
        <div className="self-stretch flex flex-col items-start justify-center gap-[5px] text-5xl font-sub-headings-sub-heading-26px-semibold">
