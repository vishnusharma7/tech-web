const Feature3 = () => {
  return (
    <section className="self-stretch [background:radial-gradient(50%_50%_at_50%_50%,_#50742F,_#000)] overflow-hidden flex flex-row items-end justify-center min-h-[560px] max-w-full text-left text-14.4-custom text-secondary-light-10 font-familymain">
      <div className="w-[1280px] flex flex-row flex-wrap items-center justify-center py-5 px-5 box-border gap-[70px] max-w-full mq450:gap-[70px] mq750:gap-[70px]">
        <div className="flex-[0.8974] rounded-t-6xl rounded-b-none flex flex-row items-end justify-end p-[30px] box-border bg-[url('/images/img3.png')] bg-cover bg-no-repeat bg-[top] min-w-[360px] min-h-[480px] max-w-full">
          <div className="w-[300px] rounded-[15.25px] bg-gray-400 [backdrop-filter:blur(24px)] flex flex-col items-center justify-start pt-7 px-[27px] pb-[27px] box-border gap-[20px]">
            <div className="self-stretch flex flex-row items-center justify-start gap-[20px] mq450:flex-wrap">
              ...
              <div className="flex flex-row items-start justify-start text-xs font-custom-bold">
                <img
            ...
            <div className="self-stretch h-[75.4px] relative text-10.2-custom text-secondary-light-60 font-inter">
              ...
              <img
                ...
                src="/process-row.svg"
              />
              <div className="absolute top-[-25px] left-[41px] w-[205px] flex flex-col items-center justify-start gap-[26px] text-secondary-dark-10 font-custom-bold">
                <div className="w-[108px] flex flex-row items-start justify-start py-0 pr-0 pl-[33px] box-border">
                  <div className="flex-1 flex flex-col items-center justify-start pt-0 px-0 pb-[13px] relative">
                    ...
                    <div className="self-stretch rounded-[5.08px] bg-primary-40 flex flex-col items-center justify-start pt-[11px] pb-2.5 pr-[11px] pl-3.5 gap-[6px] z-[3]">
                      ...
                      <input
                        className="w-full [border:none] [outline:none] font-semibold font-custom-bold text-10.2-custom bg-[transparent] self-stretch h-3.5 relative leading-[13.56px] text-secondary-dark-50 text-left inline-block min-w-[30px]"
