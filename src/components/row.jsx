...
const Row = () => {
  return (
    <div className="w-[1300px] flex flex-col items-center justify-start gap-[20px] max-w-full text-left text-xl text-primary-dark-80 font-familymain mq750:gap-[60px]" data-aos="fade-up">
      <Row1
