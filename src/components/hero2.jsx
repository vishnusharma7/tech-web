const Hero2 = () => {
  return (
    <section className="self-stretch overflow-hidden flex flex-col items-center justify-center py-[100px] pr-[420px] pl-5 box-border bg-[url('/hero@3x.jpg')] bg-cover bg-no-repeat bg-[top] max-w-full text-left text-60-custom text-secondary-light-10 font-familymain mq450:pr-5 mq450:box-border mq750:pt-[65px] mq750:pr-[105px] mq750:pb-[65px] mq750:box-border mq1250:pr-[210px] mq1250:box-border">
